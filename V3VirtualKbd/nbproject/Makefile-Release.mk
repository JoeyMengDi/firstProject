...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/App/V3VirtualKbd.exe

dist/V3/App/V3VirtualKbd.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/App
	arm-brcm-linux-gnueabi-g++ -o dist/V3/App/V3VirtualKbd ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}"

${OBJECTDIR}/_ext/511dc4f5/DebugInfo.o: ../SRC/DebugInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511dc4f5
	$(COMPILE.cc) -O2 -DCTOS_API -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/_ext/511dc4f5/DebugInfo.o ../SRC/DebugInfo.cpp

${OBJECTDIR}/CButton.o: CButton.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -DCTOS_API -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/CButton.o CButton.cpp

${OBJECTDIR}/MyKBD.o: MyKBD.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -DCTOS_API -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/MyKBD.o MyKBD.cpp
