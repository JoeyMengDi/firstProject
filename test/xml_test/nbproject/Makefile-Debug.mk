...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/Debug/V3App20140219.exe

dist/V3/Debug/V3App20140219.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/Debug
	arm-brcm-linux-gnueabi-g++ -o dist/V3/Debug/V3App20140219 ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}"
