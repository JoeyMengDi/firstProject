...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V5S/App/crypto.exe

dist/V5S/App/crypto.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V5S/App
	arm-brcm-linux-gnueabi-g++ -o dist/V5S/App/crypto ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}"
