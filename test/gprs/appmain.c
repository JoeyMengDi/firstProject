...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        CTOS_LCDTPrintXY(1, 1, "[GPRS/GSM test]");
        CTOS_LCDTPrintXY(1, 2, "1. GSM test");
        CTOS_LCDTPrintXY(1, 3, "2. GPRS Open");
        CTOS_LCDTPrintXY(1, 4, "3. GPRS Connect");
        CTOS_LCDTPrintXY(1, 5, "4. GPRS TxRx");
        CTOS_LCDTPrintXY(1, 6, "5. GPRS Disconnec");
        CTOS_LCDTPrintXY(1, 7, "6. GPRS Close");
        ...
        distance = end - start;
        memset(str, 0x00, sizeof (str));
        sprintf(str, "time: %dms       ", distance * 10);
