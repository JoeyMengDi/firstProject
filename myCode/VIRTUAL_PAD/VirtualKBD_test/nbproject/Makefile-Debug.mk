...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/upt1000/Debug/VirtualKBD_test.exe

dist/upt1000/Debug/VirtualKBD_test.exe: ${OBJECTFILES}
	${MKDIR} -p dist/upt1000/Debug
	arm-brcm-linux-gnueabi-g++ -o dist/upt1000/Debug/VirtualKBD_test ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKUPT1000LIB}" "-L${SDKUPT1000LIBN}"

${OBJECTDIR}/_ext/511dc4f5/DebugInfo.o: ../SRC/DebugInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511dc4f5
	$(COMPILE.cc) -g -I/cygdrive/C/Program\ Files/Castles/UPT1000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/UPT1000/include -o ${OBJECTDIR}/_ext/511dc4f5/DebugInfo.o ../SRC/DebugInfo.cpp
