...
#define DEBUGINFO_NORMAL   0   //Debug info normal
#define DEBUGINFO_WARNING  1   //Debug info warning
#define DEBUGINFO_ERROR    2   //Debug info error
...
#ifdef _WINDOWS
#include <Windows.h>
#pragma warning(disable : 4251 4067 4242 4244 4996 4101)
#endif
//////////////////////////////////////////////////////////////////////////
//Call Back function type.
#define  CB_MSG     0x0400
#define  CB_DEBUGINFO   CB_MSG+1  //Degug infor wParam = LPSTR, lParam = Debug Level
